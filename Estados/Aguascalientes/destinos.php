                     ...
                     <?php foreach ($model->Listar() as $r): ?>
                        ...
                        <div class="single-location mb-30">
                            <div class="location-img">
                               <?php echo ' <img src="'.$r->__GET('img_destinos').'" width=300px height=auto> '; ?>
                            </div>
                            <div class="location-details">
                                <p><?php echo $r->__GET('nom_destinos'); ?></p>
                                

                                 <center><a  data-toggle="modal" data-target="#miModal" href="#miModal?action=editar&id_destino=<?php echo $r->id_destino; ?>"><button class="location-btn">Editar</button></a></a></center>
                                    <center><a href="?action=eliminar&id_destino=<?php echo $r->id_destino; ?>"><button class="location-btn">Eliminar</button></a></a></center>
