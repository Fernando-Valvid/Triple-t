...
if (isset($_REQUEST['action'])) {
    switch ($_REQUEST['action']) {
        ...
        case 'eliminar':
            ...
            header('Location: pructos.php#faq');
            break;
                ...
                <div class="table-responsive">
                  <table class="table">
                      ...
                      <thead class=" text-primary">
                                    ...
                                    <?php foreach ($model->userProduct() as $r): ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a  href="productos.php?action=estatus&id_pro=<?php echo $r->id_pro; ?>"><button class="btn btn-success">Aprobar</button></a></td>
                                            <td class="center"><a href="productos.php?action=eliminar&id_pro=<?php echo $r->id_pro; ?>"><button id="btnSA_3" ty
