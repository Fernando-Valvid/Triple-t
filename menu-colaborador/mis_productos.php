                ...
                <div class="table-responsive">
                  <table class="table">
                      ...
                      <thead class=" text-primary">
                                    ...
                                    <?php foreach ($model->userProduct($userid) as $r): ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                             <td><?php echo $r->__GET('nombre_pro'); ?></td>
                                            <td><?php echo $r->__GET('marca_pro'); ?></td>
                                            <td><?php echo $r->__GET('modelo_pro'); ?></td>
                                            <td><?php echo ' <img src="../'.$r->__GET('img1_pro').'" width=50px height=auto>'; ?></td>
                                            <td><?php echo $r->__GET('descripcion_pro'); ?></td>
                                            
                                            
                                            <td class="center"><a  href="agregar_producto.php?action=editar&id_pro=<?php echo $r->id_pro; ?>"><button class="btn btn-success">Editar</button></a></td>
                                            
                                            <td class="center"><button value="<?php echo $r->id_pro; ?>" id="btnSA_3<?php echo $r->id_pro; ?>" type="button" class="btn btn btn-danger btnSA_3">Borrar</button></td> 
...
<!-- Plugins Alertify -->  
	...
	<script>		
      ...
      $("[id^='btnSA_3']").click(function (e){
        ...
        window.location.href='mis_productos.php?action=eliminar&id_pro=' + e.target.value;
			  } else {
