...
if (isset($_REQUEST['action'])) {
    switch ($_REQUEST['action']) {
        ...
        case 'eliminar':
            ...
            header('Location: lista_cronicas.php');
            break;
                ...
                <div class="table-responsive">
                  <table class="table">
                      ...
                      <thead class=" text-primary">
                                    ...
                                    <?php foreach ($model->userDestino( $userid) as $r): ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a  href="agregar_cronicas.php?action=editar&id_destino=<?php echo $r->id_destino; ?>"><button class="btn btn-success">Editar</button></a></td>
...
<!-- Plugins Alertify -->  
	...
	<script>		
      ...
      $("[id^='btnSA_3']").click(function (e){
        ...
        window.location.href='lista_cronicas.php?action=eliminar&id_destino=' + e.target.value;
			  } else {
