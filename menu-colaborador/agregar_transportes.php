<?php
        ...
        ?>
<?php
$mysqli = new mysqli('locallhost', 'u205223607_ttt', 'Gp0Empr3sarialV4lv1d#101#', 'u205223607_ttt');
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Transportes</h4>
                 <a  href="registrartransporte.php"><button class="btn btn-success">Agregar Transporte</button></a>
                    <br> 
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                      ...
                      <thead class=" text-primary">
                                    ...
                                    <?php foreach ($model->userTrasporte( $userid) as $r): ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="registrartransporte.php?action=editar&id_transporte=<?php echo $r->id_transporte; ?>"><button id="" type="button" class="btn btn btn-success">Editar</button></a></td>
	...
	<script>		
      ...
      $("[id^='btnSA_3']").click(function (e){
        ...
        // console.log(prodId.value);
			...
			swal({
			  title: "¿Está seguro?",
			  text: "Que quieres eliminar el trasporte!",
			  icon: "warning",
			  buttons: true,
			  dangerMode: true,
			})
			.then((willDelete) => {
			  if (willDelete) {
				swal("El trasporte ha sido eliminado!", {
        ...
        window.location.href='agregar_transportes.php?action=eliminar&id_transporte=' + e.target.value;
