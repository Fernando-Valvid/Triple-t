...
if (isset($_REQUEST['action'])) {
    switch ($_REQUEST['action']) {
        case 'actualizar':
            ...
            $des->__SET('ine', $_REQUEST['ine']);
            $des->__SET('RFC', $_REQUEST['RFC']);
            $des->__SET('foto_edo_cuenta', $_REQUEST['foto_edo_cuenta']);
            $des->__SET('logotipo_personal', $_REQUEST['logotipo_personal']);
            $des->__SET('foto_ext', $_REQUEST['foto_ext']);
            $des->__SET('foto_int', $_REQUEST['foto_int']);
            $des->__SET('curp', $_REQUEST['curp']);

    
            $model->Actualizar($des);
            header('Location: transportistas.php#pricing');
            break;
        ...
        case 'registrar':
            ...
            $des->__SET('ine', $ine);
            $model->Registrar($des);
            print"<script language='JavaScript'>alert('El transportista fue registrado satisfactoriamente');</script>";
            header('Location: transportista.php#pricing');

            break;

        case 'eliminar':
            $model->Eliminar($_REQUEST['id_transportista']);
            header('Location: transportistas.php#faq');
            break;

        case 'editar':
            $cit = $model->Obtener($_REQUEST['id_transportista']);
            break;
    }
}
?>
                ...
                <div class="row">
                        ...
                        <div class="single-location mb-30">
                            <div class="location-img">
                               <?php echo ' <img src="'.$r->__GET('ine').'" width=300px height=auto> '; ?>
                            </div>
                            <div class="location-details">
                                <p><?php echo $r->__GET('nombre_empresa'); ?></p>
