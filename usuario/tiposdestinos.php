...
if (isset($_REQUEST['action'])) {
    switch ($_REQUEST['action']) {
        ...
        case 'registrar':
            ...
            $model->Registrar($des);
           print"<script language='JavaScript'>alert('swal(Advertencia, ...texto de advertencia, warning');</script>";
        ...
        case 'eliminar':
            ...
            header('Location: tipos.php#faq');
            break;

        case 'editar':
            $cit = $model->Obtener($_REQUEST['id_turismo']);
            break;
    }
}
?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="section-tittle text-center mb-80">
                            <span>Elige el tipo de turismo que deseas</span>
                            <h2>Tipos de Turismos</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="single-location mb-30">
                            <div class="location-img">
                               <?php echo ' <img src="'.$r->__GET('img_turismo').'" width=300px height=auto> '; ?>
                            </div>
                            <div class="location-details">
                                <p><?php echo $r->__GET('nombre_turismo'); ?></p>
