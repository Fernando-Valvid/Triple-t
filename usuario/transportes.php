        ...
        <div class="men-thumb-item text-center">
            ...
            <div class="men-cart-pro">
                <div class="inner-men-cart-pro">
                    ...
                    <a href="detalles_transporte.php?id=<?php echo $r->__GET('id_transporte'); ?>" class="link-product-add-cart">Ver detalles</a>
                </div>
            </div>
        </div>
        <div class="item-info-product text-center border-top mt-4">
            <h4 class="pt-1">
            <a><?php echo $r->__GET('nom_transporte'); ?><a>
            </h4>
