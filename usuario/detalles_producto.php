...
<div id="preloader-active">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo $r->__GET('img3_pro'); ?>" data-imagezoom="true" class="img-fluid" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo $r->__GET('img2_pro'); ?>" data-imagezoom="true" class="img-fluid" alt="Third slide">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
						<h1 class="mb-3"><?php echo $r->__GET('nombre_pro'); ?></h1>
						<h2 class="mb-3"><?php echo $r->__GET('marca_pro'), ' ', $r->__GET('modelo_pro') ; ?></h2>
						<p class="mb-3">
