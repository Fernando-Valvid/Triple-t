...
<div id="preloader-active">
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" src="<?php echo $r->__GET('img_destinos'); ?>"  data-imagezoom="true" class="img-fluid" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo $r->__GET('img_destinos'); ?>" data-imagezoom="true" class="img-fluid" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo $r->__GET('img_destinos'); ?>" data-imagezoom="true" class="img-fluid" alt="Third slide">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
						<h1 class="mb-3"><?php echo $r->__GET('nom_destinos'); ?></h>
						<p class="mb-3">
						<span class="item_price"><?php echo  $r->__GET('ubicacion_geografica'); ?></span>
					...
					<div class="product-single-w3l">
						...
						<ul>
						<span class="item_price">Referencias</span>
							<li class="mb-1">
								<?php echo $r->__GET('referencias'); ?>
							</li>
