...
if (isset($_REQUEST['action'])) {
    switch ($_REQUEST['action']) {
        case 'estatus':
            ...
            $model->Estatus($des);
            header('Location: autorizardestino.php');
            break;
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Aprobar Destinos </h4>
                      ...
                      <thead class=" text-primary">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a  href="autorizardestino.php?action=estatus&id_destino=<?php echo $r->id_destino; ?>"><button  id="btnSA_1" class="btn btn-success">Aprobar</button></a></td>
...
$("[id^='btnSA_3']").click(function (e){
  ...
  window.location.href='autorizardestino.php?action=eliminar&id_destino=' + e.target.value;
        } else {
