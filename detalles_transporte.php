...
<div id="preloader-active">
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-1">
                                <div class="logo">
                                  <a href="index.html"><img src="ssets/img/logo/logo.png" alt=""></a>
                                </div>
                            </div>
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" src="<?php echo $r->__GET('img_transporte'); ?>"  data-imagezoom="true" class="img-fluid" alt="First slide">
    </div>
  </div>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					...
					<div class="product-single-w3l">
						...
						<span class="item_price">El transporte incluye:</span>
							<li class="mb-1">
								<?php echo $r->__GET('incluye'); ?>
							</li>
							<li class="mb-1">
								<?php echo $r->__GET('link_youtube'); ?>
							</li>
						<span class="item_price">No cuenta con:</span>
							<li class="mb-1">
								<?php echo $r->__GET('no_incluye'); ?>
							</li>
